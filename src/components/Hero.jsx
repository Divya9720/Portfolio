  ...
  return (
    <section id="home" className={`max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-40 text-center ${isDark ? 'text-white' : ''}`}>
      <div className="mb-8" data-aos="zoom-in">
         <div className="w-20 h-20 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-pink-200 to-purple-200 mx-auto mb-6 sm:mb-8 shadow-lg border-4 border-white flex items-center justify-center text-4xl sm:text-6xl hover:scale-110 transition cursor-pointer animate-bounce" style={{animationDelay: '0.5s'}}>
           👩‍💻
         </div>
       </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
        <a href="#projects" className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold transition shadow-lg hover:shadow-xl text-sm sm:text-base lg:text-lg hover:scale-105 active:scale-95 duration-200">
          View My Work 🚀
        </a>
        <a href="mailto:divichauhan0808@gmail.com" className="border-2 border-purple-600 text-purple-600 hover:bg-purple-50 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold transition text-sm sm:text-base lg:text-lg hover:scale-105 active:scale-95 duration-200 hover:shadow-lg">
          Contact Me 💬
        </a>
      </div>
